...
static INSTRUCTION_TABLE: &'static [Option<InstructionEntry>] = &[
    ...
    Some(InstructionEntry { opcode: BinaryOpcode::Br }),
    ...
    Some(InstructionEntry { opcode: BinaryOpcode::GetGlobal }),
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    Some(InstructionEntry { opcode: BinaryOpcode::I32Load8S }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32Load8U }),
    None,
    None,
    // 0x30 - 0x37
    None,
    ...
    Some(InstructionEntry { opcode: BinaryOpcode::I64Store }),
    // 0x38 - 0x3F
    None,
    None,
    Some(InstructionEntry { opcode: BinaryOpcode::I32Store8 }),
    None,
    None,
    None,
    None,
    ...
    Some(InstructionEntry { opcode: BinaryOpcode::I32Eq }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32Ne }),
    // 0x48 - 0x4F
    Some(InstructionEntry { opcode: BinaryOpcode::I32LtS }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32LtU }),
    None,
    None,
    None,
    None,
    None,
    Some(InstructionEntry { opcode: BinaryOpcode::I32GeU }),
    // 0x50 - 0x57
    None,
    None,
    None,
    ...
    Some(InstructionEntry { opcode: BinaryOpcode::I32Sub }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32Mul }),
    None,
    Some(InstructionEntry { opcode: BinaryOpcode::I32DivU }),
    None,
    // 0x70 - 0x77
    None,
    Some(InstructionEntry { opcode: BinaryOpcode::I32And }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32Or }),
    Some(InstructionEntry { opcode: BinaryOpcode::I32Xor }),
...
fn parse_instrs(reader: &mut Read, terminal_opcode: BinaryOpcode) -> Result<(Vec<WasmInstr>, usize), ParserErrorKind> {
    ...
    loop {
        ...
        let (instr, c) = match opcode {
            ...
            I64Store => parse_memarg(reader).map(|p| (WasmInstr::Store { attr: Storeattr::I64, arg: p.0 }, p.1))?,
